...
Gimmy 於 2026-09-07 提供的完整新版僵屍方角色素材。11 位可選角色已整理為 1024×1024 透明 WebP，供角色圖鑑、詳細資料、玩家卡片、頭像與戰場單位共同使用。
...
原始上傳圖保存在 `assets/characters/source-originals/zombie-roster-20260907/`，由專案根目錄的 `scripts/prepare_zombie_roster_assets.py` 可重製正式檔。圖3、4、6、9會移除烙入的黑底／棋盤格；始皇與烈焰屍車會水平鏡像，使攻擊朝左。
